...
namespace ProjectConvert.Conversion
{
    using ProjectConvert.Conversion.Base;
    ...
    public class AreaConverter : BaseUnitConverter
    {
        UnitFactors units = new UnitFactors("m²")
        {
            ...
            { new UnitFactorSynonyms("km²", "km2", "square kilometre"), 0.000001 },
            { new UnitFactorSynonyms("cm²", "cm2", "square centimetre"), 10000 },
            { new UnitFactorSynonyms("mm²", "mm2", "square millimetre"), 1000000 },
